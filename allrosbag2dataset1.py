...
def main():
    ...
    parser.add_argument("-b", "--rosbag-dir", type=str, default="/share/private/27th/hirotaka_saito/bagfile/sq2/d_kan1/debug/")
    parser.add_argument("-o", "--output-dir", type=str, default="/share/private/27th/hirotaka_saito/dataset/sq2/d_kan1/test_224/")
    parser.add_argument("-c", "--config-dir", type=str, default="/share/private/27th/hirotaka_saito/config1/")
    args = parser.parse_args()

    config = {}
    config["topics"] = ["camera/color/image_raw/compressed","t_frog/cmd_vel", "front_laser/scan", "t_frog/odom"]
    config["dataset"] = ["acs" ,"lidar" ,"pos" ,"obs","obsd"]
    ...
    for config_path in iglob(os.path.join(args.config_dir,"*")):
        ...
        print(config_name)
        command = "python3 ./rosbag2dataset.py --config /share/private/27th/hirotaka_saito/config1/" + config_name
